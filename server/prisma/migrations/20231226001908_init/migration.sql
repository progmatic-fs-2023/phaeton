/*
  ...
  - A unique constraint covering the columns `[zone]` on the table `ParkingLot` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "ParkingLot_zone_key" ON "ParkingLot"("zone");
